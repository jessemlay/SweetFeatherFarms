    ...
    <div className="flex flex-col mt-16 -mx-8 justify-left">
      <div className="story-section">
        ...
        <div className="flex-col items-start flex-1 max-w-4xl px-8 text-xl font-semibold leading-snug tracking-tight text-justify md:text-xl">
          <h1 className="text-lg italic leading-none text-brown md:text-5xl lg:text-5xl">
            An Idea Is Born
          </h1>

          <time
            datetime="2022-01-01"
            className="block pt-1 text-2xl font-bold leading-none uppercase text-secondary"
          >
            January 2022
          </time>
      ...
      <div className="story-section">
        ...
        <div className="flex-col items-start flex-1 max-w-4xl px-8 mt-16 text-xl font-semibold leading-snug tracking-tight text-justify">
          <h1 className="text-4xl font-bold leading-none text-brown md:text-5xl lg:text-5xl ">
            A Farm Is Born
          </h1>
        </div>
      </div>
